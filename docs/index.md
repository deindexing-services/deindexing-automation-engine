# Deindexing Automation Engine — Documentation

**Version:** 1.0.0  
**Author:** Deindexing.Services  
**Repository:** https://github.com/deindexing-services/deindexing-automation-engine  
...
Deindexing Automation Engine is an automation engine for managing search deindexing, content removal requests, review issues, and online reputation workflows across major platforms.
...
### Python CLI
```bash
deindex-run "brand-name" search-deindex 88 82 85 78 90 84
```
...
|----------|-----|
| Website | https://deindexing.services |
| GitHub | https://github.com/deindexing-services |
